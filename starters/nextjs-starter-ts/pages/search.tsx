import { ArticleWithoutContent, PCCConvenienceFunctions } from "@pantheon-systems/pcc-react-sdk";
...
export default function Search({ articles, searchString, summary }: Props) {
