...
import { h, type ComponentInstance } from "vue";
import ErrorBoundary from "./ErrorBoundary.vue";
import LeadCapture from "./LeadCapture.vue";

export default function withClientOnlyAndErrorBoundary<T extends Component>(
  Component: T,
) {
  ...
  return defineComponent({
    ...
    props: (Component as ComponentInstance<T>).props, // Bind the child component's props
    render() {
      return h(
        ErrorBoundary,
        {},
